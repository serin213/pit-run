    ...
    <View style={[StyleSheet.absoluteFill, { backgroundColor: '#17171C' }]}>
      ...
      {showCircuitCard && (
        ...
        >
          ...
          <Text style={[s.statLabel, { left: 20, top: 88 }]}>DISTANCE</Text>
          <Text style={[s.statValue, { left: 20, top: 110 }]}>
            {circuit.distanceKm.toFixed(1)}km
          </Text>

          <Text style={[s.statLabel, { left: 20, top: 154 }]}>RACE TIME</Text>
          <Text style={[s.statValue, { left: 20, top: 176 }]}>{raceTimeStr}</Text>

          <Text style={[s.statLabel, { left: 20, top: 220, fontSize: 15 }]}>TYRE</Text>
